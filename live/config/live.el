...
(setq live-lib-dir (concat live-config-dir "../lib/"))
...
(defun add-live-lib-path (p)
  (add-to-list 'load-path (concat live-lib-dir p)))

;; Add the lib dir to the load-path
(add-to-list 'load-path live-lib-dir)
(require 'dircolors)
...
(load-live-config-file "ibuffer-git-conf.el")
