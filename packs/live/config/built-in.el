...
(make-directory (concat live-tmp-dir "autosaves") t)
(make-directory (concat live-tmp-dir "backups") t)

;; Put autosave files (ie #foo#) and backup files (ie foo~) in ~/.emacs.d/tmp/
(setq backup-by-copying t)
(setq auto-save-file-name-transforms `((".*" ,(concat live-tmp-dir "autosaves/\\1") t)))
(setq backup-directory-alist `((".*" . ,(concat live-tmp-dir "backups"))))
(setq auto-save-list-file-name (concat live-tmp-dir "autosaves/autosave-list"))
...
(setq redisplay-dont-pause t
      ...
      save-place-file (concat live-tmp-dir "places"))
