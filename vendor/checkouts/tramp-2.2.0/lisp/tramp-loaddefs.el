...
(unless (featurep 'xemacs) (add-to-list 'tramp-methods (cons tramp-ftp-method nil)))
...
(when (and (locate-library "epa") (locate-library "imap-hash")) (add-to-list 'tramp-methods (list tramp-imap-method '(tramp-default-port 143))))

(defconst tramp-imaps-method "imaps" "\
*Method to connect via secure IMAP protocol.")

(when (and (locate-library "epa") (locate-library "imap-hash")) (add-to-list 'tramp-methods (list tramp-imaps-method '(tramp-default-port 993))))
...
(autoload 'tramp-imap-file-name-handler "tramp-imap" "\
...
(when (and (locate-library "epa") (locate-library "imap-hash")) (add-to-list 'tramp-foreign-file-name-handler-alist (cons 'tramp-imap-file-name-p 'tramp-imap-file-name-handler)))
...
(add-to-list 'tramp-methods '("pscp" (tramp-login-program "plink") (tramp-login-args (("-l" "%u") ("-P" "%p") ("-ssh") ("%h"))) (tramp-remote-sh "/bin/sh") (tramp-copy-program "pscp") (tramp-copy-args (("-P" "%p") ("-scp") ("-p" "%k"))) (tramp-copy-keep-date t) (tramp-password-end-of-line "xy") (tramp-default-port 22)))

(add-to-list 'tramp-methods '("psftp" (tramp-login-program "plink") (tramp-login-args (("-l" "%u") ("-P" "%p") ("-ssh") ("%h"))) (tramp-remote-sh "/bin/sh") (tramp-copy-program "pscp") (tramp-copy-args (("-P" "%p") ("-sftp") ("-p" "%k"))) (tramp-copy-keep-date t) (tramp-password-end-of-line "xy")))
...
;;;***

;;;### (autoloads nil "trampver" "trampver.el" (19723 42716))
